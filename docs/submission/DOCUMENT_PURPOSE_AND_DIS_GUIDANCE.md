...
- **`DIS_SUBMISSION_REPORT.md`** ⭐ **[PRIMARY]** - Complete analysis and findings (2026-01-09)
- **`METHODS_AND_CONCEPTS.md`** (classifier/) - Full methodology and taxonomy
- **Purpose:** Authoritative research documentation
- **Audience:** Research team, reviewers, external references
- **Use:** Complete findings, methodology, and theoretical framework

### Archived Research Documentation (Historical)
- **`RESEARCH_FINDINGS_REPORT_REFRAMED.md`** (archived) - Superseded by DIS_SUBMISSION_REPORT.md
- **Purpose:** Historical research documentation
