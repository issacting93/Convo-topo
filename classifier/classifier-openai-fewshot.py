#!/usr/bin/env python3
"""
Conversation Metadata Classifier v1.2 (OpenAI Version with Few-Shot Examples)

Enhanced version with few-shot learning for better role classification accuracy.

Usage:
    python classifier-openai-fewshot.py conversations.json output.json --few-shot-examples few-shot-examples.json
    python classifier-openai-fewshot.py conversations.json output.json --few-shot-examples few-shot-examples.json --individual --output-dir public/output
"""
...
# ============================================================================
# PROMPT TEMPLATE (Same as v1.2, but with few-shot section)
# ============================================================================
...
# ============================================================================
# POST-PROCESSING CORRECTIONS (Same as v1.2)
# ============================================================================
...
def detect_pseudo_problem_solving(conversation: dict) -> Optional[dict]:
    ...
    generic_phrases = [
        "i don't have", "as an ai", "i cannot", "it's important to",
        "you should", "i'm sorry", "i understand"
    ]
...
def detect_collaboration(conversation: dict) -> Optional[dict]:
    ...
    feedback_keywords = ['improve', 'better', 'issues', 'problems', 'wrong', 'change', 'fix', 'modify', 'adjust', 'revise']
    directive_keywords = ['rewrite', 'redo', 'try again', 'make it', 'add', 'remove', 'include', 'exclude']
...
# ============================================================================
# CLASSIFIER (Few-Shot Version)
# ============================================================================

def classify_messages(client: OpenAI, messages: list, few_shot_examples: str = "", model: str = "gpt-4") -> dict:
...
def classify_conversation(client: OpenAI, conversation: dict,
    ...
    """Classify a full conversation with few-shot examples and optional corrections"""
    ...
    for i, convo in enumerate(conversations):
        try:
            result = classify_conversation(
                client, convo, few_shot_examples, model, apply_corrections_flag
            )
...
def main():
    ...
    print(f"\nClassifying with {model} (OpenAI) FEW-SHOT {corrections_msg}...\n")
